...
##### 12. 获取小说章节内容（link以.txt结尾）

| 类型     | 值                                        |
| ------ | ---------------------------------------- |
| 接口地址   | chapterup.zhuishushenqi.com/chapter/     |
| 参数     | link: 章节地址（注：需要将link中http:/替换为http:%2F,?替换为%3F）                              |
| 实例接口地址 | http://chapter2.zhuishushenqi.com/chapter/http:%2F/book.my716.com/getBooks.aspx%3Fmethod=content&bookId=1228859&chapterFile=U_1228859_201901151602170977_2383_1.txt |
